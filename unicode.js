...
let swapLetter1 = String.fromCharCode(inputString2.charCodeAt(0));
let swapLetter2 = String.fromCharCode(inputString2.charCodeAt(5));
let swappedString = swapLetter2 + inputString2.slice(1,5) + swapLetter1;
